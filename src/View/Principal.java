...
public class Principal extends javax.swing.JFrame {
    ...
    private void item1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_item1ActionPerformed
        CadSetor cadsetor = new CadSetor(null, true);
        cadsetor.setVisible(true);
        cadsetor.setTitle("Sistema de Chamados");

    }//GEN-LAST:event_item1ActionPerformed

    private void jMenuItem1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem1ActionPerformed
        CadFuncionarios cadfuncionarios = new CadFuncionarios();
        jDesktopPane1.add(cadfuncionarios);
    ...
    private void jMenuItem3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem3ActionPerformed
        CadastroChamado CadChamado = new CadastroChamado();
        jDesktopPane1.add(CadChamado);
